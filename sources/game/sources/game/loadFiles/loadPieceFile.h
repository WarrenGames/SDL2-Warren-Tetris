...
void loadPieceMatrixData(AppLogFiles& logs, const std::string& filePath, std::ifstream& inputFile, MatrixTemp2D<SquareData>& matrix, LoadedPieces& pieces, unsigned color);
