...
struct OptionsMenuElements
{
	...
	void pollEvents(Essentials& essentials, bool& canWaitInput, size_t keycodeNum);
	
	void updateModifications(Essentials& essentials, bool& canWaitInput, size_t keycodeNum, SDL_Keycode& keycode);
};
