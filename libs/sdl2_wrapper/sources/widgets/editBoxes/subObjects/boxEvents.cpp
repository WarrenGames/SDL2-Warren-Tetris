...
BoxEvents::BoxEvents():
	numbersState{false, false, false, false, false, false, false, false, false, false},
	specificKeys{false, false, false, false},
	lowerCaseLetters(ALPHA_CASE_NUM),
	upperCaseLetters(ALPHA_CASE_NUM),
...
void BoxEvents::resetAllKeys()
{
	std::fill(lowerCaseLetters.begin(), lowerCaseLetters.end(), false);
	std::fill(upperCaseLetters.begin(), upperCaseLetters.end(), false);
	numbersState.fill(false);
	specificKeys.fill(false);
}
