...
void Matrix3DTexturesDrawing::resetTextures(const Matrix3DTexturesLoading& loadedTextures)
{
	...
	{
		for( size_t depth{0} ; depth < loadedTextures.depth() ; ++depth )
		{
...
size_t Matrix3DTexturesDrawing::width() const
{
	return sprites.width();
}

size_t Matrix3DTexturesDrawing::height() const
{
	return sprites.height();
}

size_t Matrix3DTexturesDrawing::depth() const
{
