...
{
	for( size_t width{0} ; width < piece.width(getNextMatrixClockwiseOrder(activeP.rotateIndex)) ; ++width )
	{
		for( size_t height{0} ; height < piece.height(getNextMatrixClockwiseOrder(activeP.rotateIndex)) ; ++height )
		{
...
{
	for( size_t width{0} ; width < piece.width(getNextMatrixAntiClockwiseOrder(activeP.rotateIndex)) ; ++width )
	{
		for( size_t height{0} ; height < piece.height(getNextMatrixAntiClockwiseOrder(activeP.rotateIndex)) ; ++height )
		{
